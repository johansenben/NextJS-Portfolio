...
export function SolveButton({ setIsSolving }: { setIsSolving: (isSolving: boolean) => void }) {
	return (
		<div
...
export function PencilToggle({ togglePencil, isPencilOn }: { togglePencil: () => void; isPencilOn: boolean }) {
	return (
		<div
			...
			className={clsx("select-none cursor-pointer", isPencilOn ? "text-blue-600" : "text-black")}
		>
